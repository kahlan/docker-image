...
everything:
	make all DOCKERFILE=3.1/debian VERSION=3.1.2 \
	         TAGS=3.1,3,latest
	make all DOCKERFILE=3.1/php5-debian VERSION=3.1.2 \
	         TAGS=3.1-php5,3-php5,php5
	make all DOCKERFILE=3.1/alpine VERSION=3.1.2-alpine \
	         TAGS=3.1-alpine,3-alpine,alpine
	make all DOCKERFILE=3.1/php5-alpine VERSION=3.1.2-php5-alpine \
