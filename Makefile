...
ALL_IMAGES := \
	4/debian:4.3.0,4.3,4,latest \
	4/php5-debian:4.3.0-php5,4.3-php5,4-php5,php5 \
	4/alpine:4.3.0-alpine,4.3-alpine,4-alpine,alpine \
	4/php5-alpine:4.3.0-php5-alpine,4.3-php5-alpine,4-php5-alpine,php5-alpine
