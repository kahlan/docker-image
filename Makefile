...
ALL_IMAGES := \
	4/debian:4.6.2,4.6,4,latest \
	4/php5-debian:4.6.2-php5,4.6-php5,4-php5,php5 \
	4/alpine:4.6.2-alpine,4.6-alpine,4-alpine,alpine \
	4/php5-alpine:4.6.2-php5-alpine,4.6-php5-alpine,4-php5-alpine,php5-alpine
