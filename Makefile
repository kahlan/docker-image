...
ALL_IMAGES := \
	4/debian:4.7.2,4.7,4,latest \
	4/php5-debian:4.7.2-php5,4.7-php5,4-php5,php5 \
	4/alpine:4.7.2-alpine,4.7-alpine,4-alpine,alpine \
	4/php5-alpine:4.7.2-php5-alpine,4.7-php5-alpine,4-php5-alpine,php5-alpine
