...
ALL_IMAGES := \
	4.0/debian:4.0.2,4.0,4,latest \
	4.0/php5-debian:4.0.2-php5,4.0-php5,4-php5,php5 \
	4.0/alpine:4.0.2-alpine,4.0-alpine,4-alpine,alpine \
	4.0/php5-alpine:4.0.2-php5-alpine,4.0-php5-alpine,4-php5-alpine,php5-alpine \
