...
ALL_IMAGES := \
	4.1/debian:4.1.2,4.1,4,latest \
	4.1/php5-debian:4.1.2-php5,4.1-php5,4-php5,php5 \
	4.1/alpine:4.1.2-alpine,4.1-alpine,4-alpine,alpine \
	4.1/php5-alpine:4.1.2-php5-alpine,4.1-php5-alpine,4-php5-alpine,php5-alpine \
