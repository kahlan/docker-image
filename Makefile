...
ALL_IMAGES := \
	3.1/debian:3.1.14,3.1,3,latest \
	3.1/php5-debian:3.1.14-php5,3.1-php5,3-php5,php5 \
	3.1/alpine:3.1.14-alpine,3.1-alpine,3-alpine,alpine \
	3.1/php5-alpine:3.1.14-php5-alpine,3.1-php5-alpine,3-php5-alpine,php5-alpine
